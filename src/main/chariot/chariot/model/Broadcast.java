...
public record Broadcast(Tour tour, List<Round> rounds)  {
    ...
    public record TourWithLastRound(Tour tour, RoundByUser lastRound) {}
    public record RoundByUser(String id, String name, String slug, ZonedDateTime createdAt, boolean ongoing, boolean finished, Optional<ZonedDateTime> startsAt, URI url) {}
}
