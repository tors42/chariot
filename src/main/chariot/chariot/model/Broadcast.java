...
public record Broadcast(Tour tour, List<Round> rounds)  {
    ...
    public record Tour(String id, String name, String slug, String description, ZonedDateTime createdAt, int tier, String markup, URI url, boolean teamTable, boolean leaderboard) {}
