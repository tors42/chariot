...
```java
//DEPS io.github.tors42:chariot:0.0.37
//JAVA 17+
...
The coordinates are `io.github.tors42:chariot:0.0.37`, so in a Maven project the following dependency can be added to the `pom.xml`:
