...
`io.github.tors42:chariot:0.2.5`, so in a Maven project the following
...
<pre>
jshell> <b>Files.write(Path.of("chariot-0.2.5.jar"), URI.create("https://repo1.maven.org/maven2/io/github/tors42/chariot/0.2.5/chariot-0.2.5.jar").toURL().openStream().readAllBytes());</b>
$1 ==> chariot-0.2.5.jar

jshell> <b>/env --module-path chariot-0.2.5.jar --add-module chariot</b>
