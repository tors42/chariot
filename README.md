...
The coordinates are `io.github.tors42:chariot:0.1.6`, so in a Maven project
...
<pre>
jshell> <b>Files.write(Path.of("chariot-0.1.6.jar"), URI.create("https://repo1.maven.org/maven2/io/github/tors42/chariot/0.1.6/chariot-0.1.6.jar").toURL().openStream().readAllBytes());</b>
$1 ==> chariot-0.1.6.jar

jshell> <b>/env --module-path chariot-0.1.6.jar --add-module chariot</b>
