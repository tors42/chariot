...
import chariot.api.Users.CrosstableParams;
import chariot.api.Users.UserStatusParams;
 ...
 */
public abstract class UsersHandler {
    protected final RequestHandler requestHandler;

    protected UsersHandler(RequestHandler requestHandler) {
        this.requestHandler = requestHandler;
    }

    public static Users of(RequestHandler rh) {
        return new Users(rh);
    }

    public static UsersAuth ofAuth(RequestHandler rh) {
        return new UsersAuth(rh);
    }
