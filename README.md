...
```java
//DEPS io.github.tors42:chariot:0.0.40
//JAVA 17+
...
The coordinates are `io.github.tors42:chariot:0.0.40`, so in a Maven project the following dependency can be added to the `pom.xml`:
