...
The coordinates are `io.github.tors42:chariot:0.1.16`, so in a Maven project
...
<pre>
jshell> <b>Files.write(Path.of("chariot-0.1.16.jar"), URI.create("https://repo1.maven.org/maven2/io/github/tors42/chariot/0.1.16/chariot-0.1.16.jar").toURL().openStream().readAllBytes());</b>
$1 ==> chariot-0.1.16.jar

jshell> <b>/env --module-path chariot-0.1.16.jar --add-module chariot</b>
...
Team Lichess Swiss has 602949 members!
