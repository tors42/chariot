...
public record Broadcast(Tour tour, List<Round> rounds, Opt<Group> group)  {
    ...
    public record Round(String id, String name, String slug, ZonedDateTime createdAt, boolean ongoing, boolean finished, boolean startsAfterPrevious, Opt<ZonedDateTime> startsAt, Opt<ZonedDateTime> finishedAt, Opt<RoundTour> tour, URI url) {}
